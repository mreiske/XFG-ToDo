...
# Book:        XFG
# ---------------------------------------------------------------------
# See also:    VaRcharfDG, VaRcgfDG
# ---------------------------------------------------------------------
# Quantlet:    XFGVaRcgfDGtest
# ---------------------------------------------------------------------
# Description: XFGVaRcgfDGtest plots the cumulant generating function for a 
...
# Input:       None
# ---------------------------------------------------------------------
# Output:      Plot of the cumulant generating function for a 
#              distribution, which is close to normal distribution. The 
#              graph is close to a parabola.
# ---------------------------------------------------------------------
# Example:   
...
# ---------------------------------------------------------------------
# Result:     Plots the cumulant generating function for a 
#             distribution, which is close to normal distribution. The 
#             graph is close to a parabola.       
# ---------------------------------------------------------------------
# Keywords:   cumulant generating function, Delta-Gamma-models
# ---------------------------------------------------------------------
