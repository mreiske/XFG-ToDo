...
# Quantlet:    VaRqDG
# ---------------------------------------------------------------------
# Description: computes the a-quantile for the class of quadratic forms
#              of Gaussian vectors# uses Fourier inversion to approximate
...
# Input:      
# Parameter   a
# Definition  scalar, representing the probability level
# Parameter   par
...
# Parameter   N
# Definition  scalar, modulus of the FFT used in the inversion, should have 
#             a power of 2
# Parameter   K
# Definition  scalar, number of characteristic function evaluations to use,
#             K <= N
# Parameter   dt
# Definition  scalar, grid-size in t to use for the approximation of the
#             inversion integral
# ---------------------------------------------------------------------
# Output:      
# Parameter   q
# Definition  scalar, the a-quantile
# ---------------------------------------------------------------------
# Example:       
#       theta  = 0
#       delta  = c(0)
...
#       qnorm(0.95)
# ---------------------------------------------------------------------
# Result:      Approximates a standard normal quantile and compares it
...
# 		[1] 1.644854 
# ---------------------------------------------------------------------
# Keywords:   quantile, Fourier inversion, Delta-Gamma-models
# ---------------------------------------------------------------------
