...
# Quantlet:    VaRcdfDG
# ---------------------------------------------------------------------
# Description: approximates the cumulative distribution function (CDF)
#              for the class of quadratic forms of Gaussian vectors.
# ---------------------------------------------------------------------
# Usage:       r = VaRcdfDG(l,N,K,dt)
# ---------------------------------------------------------------------
# Input:       
# Parameter   l
# Definition  a list containing (at least) the components:
#  
# 		     theta - the constant
#  
...
# Parameter   N
# Definition  scalar, modulus of the FFT, should have a power of 2
# Parameter   K
# Definition  scalar, number of characteristic function evaluations; K<=N 
# Parameter   dt
# Definition  scalar, grid-length in t to use for the approximation
# ---------------------------------------------------------------------
# Output:      
# Parameter   r
# Definition  a list containing the two components:
# 
# 	          x - the grid (vector) in x
# 
# 	          y - the values of the CDF on the grid x
# ---------------------------------------------------------------------
# Notes:       It uses an equidistantly sampled approximation to the 
#              Fourier inversion integral and applies the Fourier inversion 
#              to the function F-N, where F is the CDF at hand and N is 
#              the CDF of the normal distribution with matching mean and 
#              standard deviation.
# ---------------------------------------------------------------------
# Example:
...
# ---------------------------------------------------------------------
# Result:      Plots the CDF of a distribution, which is close to the
